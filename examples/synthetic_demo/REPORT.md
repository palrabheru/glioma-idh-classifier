# Glioma IDH Classification Report

## Scope

These values come from synthetic data and have no clinical meaning.

The workflow analyzed **180 samples** and **150 expression features**. A stratified split reserved **45 samples** for final evaluation. Model selection used 5-fold cross-validation on the training set only.
